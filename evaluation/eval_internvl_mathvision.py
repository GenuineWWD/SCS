...
dataset_test = load_dataset("path/to/Mathvision/data",split = "test")
...
dataset_test = dataset_test.filter(lambda x: len(x['options']) > 0 )
import torch
...
def collate_fn(batch):
    ...
    for example in batch:
        ...
        choices_list.append(example["options"])
